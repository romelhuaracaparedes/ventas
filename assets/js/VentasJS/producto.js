...
$("#btn-guardar").click(function() {
    ...
    var precio = $.trim($('#precio_producto').val());
    var precio_venta = $.trim($('#precio_venta_producto').val());
    ...
    if (precio == '') {
        msj_error += 'Ingresar Precio. <br>';
    }
    if (precio_venta == '') {
        msj_error += 'Ingresar Precio Venta. <br>';
    }
    if (categoria == '0') {
...
function getProductoById(id) {
    productoJS.obtener_producto(id, function(data) {
        ...
        $('#precio_producto').val(data.precio_compra);
