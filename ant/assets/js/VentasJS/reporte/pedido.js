...
var reporteJS = {
    ...
    flltarreporte: function(dataGen, callback) {
        ventasJS.post('reporte_pedido', dataGen, function(data) {
            console.log(data);
            if (callback) {
                callback(data);
            }
    ...
    listarPedidos: function(param = null) {
        ...
        var tblEntidad = $('#tablaventas').DataTable({
            ...
            "buttons": [{
                    ...
                    messageTop: function() {
                        return "FECHA: " + $('#reportrange').data('daterangepicker').startDate.format('DD-MM-YYYY') + " AL " + $('#reportrange').data('daterangepicker').endDate.format('DD-MM-YYYY');
                    },
                    title: '',
