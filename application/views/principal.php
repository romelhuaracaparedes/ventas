    ...
    <div class="col-span-12 xl:col-span-4 mt-6">
        ...
        <div class="mt-5">
            <div class="intro-y">
                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-4.jpg">
                    </div>
                    <div class="ml-4 mr-auto">
                        <div class="font-medium">Denzel Washington</div>
                        <div class="text-gray-600 text-xs">24 June 2022</div>
                    </div>
            ...
            <div class="intro-y">
                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-10.jpg">
                    </div>
                    <div class="ml-4 mr-auto">
                        <div class="font-medium">Arnold Schwarzenegger</div>
                        <div class="text-gray-600 text-xs">9 June 2022</div>
                    </div>
                    <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                </div>
            </div>
            <div class="intro-y">
                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-1.jpg">
                    </div>
                    <div class="ml-4 mr-auto">
                        <div class="font-medium">Robert De Niro</div>
                        <div class="text-gray-600 text-xs">9 September 2020</div>
                    </div>
                    <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                </div>
            </div>
            <div class="intro-y">
                <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                    <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                        <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-11.jpg">
                    </div>
                    <div class="ml-4 mr-auto">
                        <div class="font-medium">Al Pacino</div>
                        <div class="text-gray-600 text-xs">14 January 2021</div>
                    </div>
                    <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                </div>
            </div>
                ...
                <tbody>
                        ...
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-7.jpg" title="Uploaded at 24 June 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-6.jpg" title="Uploaded at 14 December 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-2.jpg" title="Uploaded at 29 December 2021">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-13.jpg" title="Uploaded at 9 June 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-4.jpg" title="Uploaded at 4 September 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-2.jpg" title="Uploaded at 29 July 2022">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-5.jpg" title="Uploaded at 9 September 2020">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-4.jpg" title="Uploaded at 10 October 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-8.jpg" title="Uploaded at 19 November 2022">
                                </div>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr class="intro-x">
                        <td class="w-40">
                            <div class="flex">
                                <div class="w-10 h-10 image-fit zoom-in">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-10.jpg" title="Uploaded at 14 January 2021">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-3.jpg" title="Uploaded at 21 May 2022">
                                </div>
                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                    <img alt="Midone Tailwind HTML Admin Template" class="tooltip rounded-full" src="<?=base_url()?>assets/images/preview-3.jpg" title="Uploaded at 4 September 2022">
                                </div>
                            </div>
                        </td>
                        <td>
        ...
        <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
            ...
            <div class="mt-5">
                ...
                <div class="intro-x">
                    <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-7.jpg">
                        </div>
                        <div class="ml-4 mr-auto">
                            <div class="font-medium">Kate Winslet</div>
                            <div class="text-gray-600 text-xs">20 March 2022</div>
                        </div>
                        <div class="text-theme-9">+$78</div>
                    </div>
                </div>
            ...
            <div class="report-timeline mt-5 relative">
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-8.jpg">
                        </div>
                    </div>
                        ...
                        <div class="text-gray-600">
                            ...
                            <div class="flex mt-2">
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Apple MacBook Pro 13">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="<?=base_url()?>assets/images/preview-10.jpg">
                                </div>
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Q90 QLED TV">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="<?=base_url()?>assets/images/preview-4.jpg">
                                </div>
                                <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Nike Air Max 270">
                                    <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white" src="<?=base_url()?>assets/images/preview-9.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-13.jpg">
                        </div>
                    </div>
                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        <div class="flex items-center">
                        ...
                        <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark:text-theme-10" href="">Nike Tanjun</a> price and description</div>
                    </div>
                </div>
                <div class="intro-x relative flex items-center mb-3">
                    <div class="report-timeline__image">
                        <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                            <img alt="Midone Tailwind HTML Admin Template" src="<?=base_url()?>assets/images/profile-15.jpg">
                        </div>
                    </div>
                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        <div class="flex items-center">
                        ...
                        <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark:text-theme-10" href="">Sony Master Series A9G</a> description</div>
                    </div>
                </div>
            </div>
        </div>
