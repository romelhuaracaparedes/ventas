...
<body class="card-no-border">
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(https://comexa.com.bo/wp-content/uploads/2015/09/Abstract-Background-White.jpg);">
            <div class="login-box card" style="width: 850px;">

                <center>
                    <img src="https://mininter.nec.pe/wp-content/uploads/2020/10/LogoMININTER.png" alt="" width="350px">
                    <br>
                    <h3 class="box-title m-b-20">MÓDULO DE CITAS VIRTUALES</h3>
                    <h3 class="box-title m-b-20"><b>REGISTRAR CUENTA</b> </h3>
                </center>
                ...
                <div class="card-body">
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Nacimiento Ubigeo:</label>
                                <input type="text" id="asd" class="form-control">
                            </div>
                        </div>
