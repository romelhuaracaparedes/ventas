                                            ...
                                            <div class="py-2">
                                                <div class="row py-2">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" id="nombres" value='<?php echo($perfil[0]["nombres"]) ?>' >
                                                    </div>
                                                    <div class="col-md-6 pt-md-0 pt-3">
                                                        <label for="ape-paterno">Apellido paterno</label>
                                                        <input type="text" class="form-control" id="ape-paterno" value='<?php echo($perfil[0]["apellido_paterno"]) ?>' >
                                                    </div>
                                                </div>
                                                <div class="row py-2">
                                                    <div class="col-md-6">
                                                        <label for="ape-materno">Apellido materno</label>
                                                        <input type="text" class="form-control" id="ape-materno" value='<?php echo($perfil[0]["apellido_materno"]) ?>' >
                                                    </div>
                                                    <div class="col-md-6 pt-md-0 pt-3">
                                                        <label for="correo">Correo</label>
                                                        <input type="text" class="form-control" id="correo" value='<?php echo($perfil[0]["correo"]) ?>' >
                                                    </div>
                                                </div>
                                                <div class="row py-2">
                                                    <div class="col-md-6">
                                                        <label for="celular">Celular</label>
                                                        <input type="tel" class="form-control" id="celular" value='<?php echo($perfil[0]["telefono"]) ?>' >
                                                    </div>
                                                    <div class="col-md-6 pt-md-0 pt-3">
                                                ...
                                                <div class="row py-2">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="tipo-documento" id="tipo-documento" class="select2-no-search">
															<option value="1" <?php echo($perfil[0]["telefono"]==1?'selected':'') ?>>DNI</option>
															<option value="2" <?php echo($perfil[0]["telefono"]==2?'selected':'') ?>>Carnet de extranjería</option>
														</select>
                                                    </div>
                                                    <div class="col-md-6 pt-md-0 pt-3">
                                                        <label for="num-documento">N° de documento</label>
                                                        <input type="text" class="form-control" id="num-documento" value='<?php echo($perfil[0]["numero_documento"]) ?>' >
                                                    </div>
                                                </div>
