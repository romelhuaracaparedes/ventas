...
class Producto_model extends Base_model {
	...
	public function _get_producto(){
        $this->db->select('p.id_producto, c.nombre_categoria, p.id_categoria, m.nombre_marca ,p.id_marca, pre.nombre_presentacion ,p.id_presentacion,p.nombre_producto,p.stock,p.stock_minimo,p.precio_venta,p.precio_compra');
    ...
    public function _get_producto_by_id($id_producto){
        $this->db->select('id_producto, id_categoria,id_marca,id_presentacion,nombre_producto,stock,stock_minimo,precio_venta,precio_compra');
    ...
    public function _insert_producto($nombre,$stock,$stockmin,$precio,$precio_venta,$categoria,$presentacion,$marca){
        $data = array(
    ...
    public function _update_producto($id_producto=0,$nombre,$stock,$stockmin,$precio,$precio_venta,$categoria,$presentacion,$marca){
        $data = array(
            'nombre_producto' => $nombre,
            'stock' => $stock,
            'stock_minimo' => $stockmin,
